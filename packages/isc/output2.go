...
func AnchorOutputWithIDFromChainOutputs(co *ChainOutputs) *AnchorOutputWithID {
	return NewAnchorOutputWithID(co.AnchorOutput, co.AnchorOutputID)
}
...
func (o *AnchorOutputWithID) Equals(other *AnchorOutputWithID) bool {
	return o.outputID == other.outputID
}

func (o *AnchorOutputWithID) InChainOutputs(co *ChainOutputs) bool {
	return o.outputID == co.accountOutputID
}

func (o *AnchorOutputWithID) StateIndex() uint32 {
	return o.AnchorOutput().StateIndex
}

func (o *AnchorOutputWithID) StateController() iotago.Address {
	return o.AnchorOutput().StateController()
}
