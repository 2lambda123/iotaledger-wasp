...
func (n *NodeData) Write(w io.Writer) error {
	...
	if err2 := util.WriteByte(w, smallFlags); err2 != nil {
		return err2
	}
	if smallFlags&isExtensionNodeFlag != 0 {
		if err2 := util.WriteBytes(w, pathExtensionEncoded); err2 != nil {
			return err2
		}
	}
	...
	if smallFlags&hasChildrenFlag != 0 {
		if err2 := util.WriteUint16(w, uint16(childrenFlags)); err2 != nil {
			return err2
		}
