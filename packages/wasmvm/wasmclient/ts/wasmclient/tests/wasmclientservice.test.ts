...
const MYCHAIN = 'atoi1pzdqqgx205qr9r9w3wnzdm4r2tgnyzrd2qpjk7rcm0eatykddxzmjh7wa89';
...
function setupClient() {
    const svc = new WasmClientService('http://localhost:19090', 'ws://localhost:19090/ws');
