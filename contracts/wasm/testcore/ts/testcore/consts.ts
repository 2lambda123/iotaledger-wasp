...
export const ViewFibonacciLoop               = "fibonacciLoop";
...
export const HFuncLoop                        = new wasmtypes.ScHname(0xa9a20fa9);
...
export const HViewFibonacciLoop               = new wasmtypes.ScHname(0x321f4d28);
