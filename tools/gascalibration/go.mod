...
require (
	...
	github.com/iotaledger/hive.go/ds v0.0.0-20231024193930-47c6046e38a8 // indirect
	...
	github.com/iotaledger/hive.go/stringify v0.0.0-20231019074837-11ac86cdca66 // indirect
