...
require (
	...
	github.com/iotaledger/hive.go/constraints v0.0.0-20230829151000-a4416d2e9c93
	...
	github.com/iotaledger/hive.go/objectstorage v0.0.0-20231012193529-491497954a58
